...
const dataPath = __dirname + "/JOY/approvedThreads.json";
const dataPending = __dirname + "/JOY/pendingdThreads.json";
const fs = require("fs");
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
    ...
    else api.sendMessage("[ OK ] ✨ApKa Group Approved 🙌.\n 🖤So Enjoy\n\n 💝🥀OWNER:- ☞JOY AHMED☜ 💫\n 🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 JOY🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=100000121528628\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @JOY_AHMED_88😇", idBox, (error, info) => {
